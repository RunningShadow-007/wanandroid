...
public final class NetworkUtils {
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) App.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) App.getApp().getSystemService(WIFI_SERVICE);
        if (wm == null) return "";
